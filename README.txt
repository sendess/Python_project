...
The discord bots are added to a server and my bot gives 20+ command features and moderation jobs for a server.
like keeping a clean server channels (i.e. removing a text containing bad words) and many more
